...
use App\FrontBundle\Entity\Formation;
...
class FormationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $formations = $em->getRepository('AppFrontBundle:Formation')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('App\FrontBundle\Form\FormationType', $formation);
    ...
    {
        $deleteForm = $this->createDeleteForm($formation);
        $editForm = $this->createForm('App\FrontBundle\Form\FormationType', $formation);
